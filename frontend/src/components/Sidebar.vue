    ...
    <nav class="mt-6 px-3">
      <div class="space-y-1">
        ...
        <router-link to="/reports" 
                     class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200"
                     :class="$route.name === 'Reports' ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'">
          <svg class="mr-3 h-5 w-5 flex-shrink-0 transition-colors duration-200" 
               :class="$route.name === 'Reports' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500'" 
               fill="none" viewBox="0 0 24 24" stroke="currentColor">
